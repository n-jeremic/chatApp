document.querySelector('form').addEventListener('submit', async event => {
  ...
  document.querySelector('.btn--login').innerHTML = '<span class="spinner-border spinner-grow-sm" role="status" aria-hidden="true"></span> Loading..';
...
async function resetPassword(clickedBtn) {
  ...
  clickedBtn.innerHTML = '<span class="spinner-border spinner-grow-sm" role="status" aria-hidden="true"></span> Submitting..';
